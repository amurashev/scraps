...
import ArticleCard, {
  ArticleCardSkeleton,
  ArticleCardProps,
} from '@/components/parts/articles/article-card-v-2'
...
export default function ComponentArticleCardV2Page() {
  const componentIndex = 'article-card-v-2'
      ...
      cases={[
        {
          ...
          jsx: (
            <Wrapper>
              <EnhancedItem {...defaultProps} isLiked />
              <EnhancedItem
                {...defaultProps}
                {...articles[2]}
                {...users[2]}
